        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <a href="delete_product.php?id=<?php echo $row['id']; ?>" class="delete-icon" onclick="return confirm('Khang chắc chắn muốn xóa món này không?')" title="Xóa"><i class="fas fa-trash"></i></a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
