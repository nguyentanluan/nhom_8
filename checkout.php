                ...
                if (!empty($_SESSION['cart'])) {
                    foreach ($_SESSION['cart'] as $id => $quantity) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="update_cart.php?id=<?php echo $id; ?>&action=delete" style="color: #e53e3e; font-size: 1.1rem;" onclick="return confirm('bạn muốn xóa món này ra khỏi giỏ hàng hả?')">
                    ...
                    echo "<tr><td colspan='6' style='text-align: center; padding: 40px; color: #999;'>Giỏ hàng trống không nha bạn ơi!</td></tr>";
                }
                ?>
            </tbody>
        </table>
